...
- **v1.1c — Prijava problema (bug report) — ✅ GOTOVO (29.06.2026.).** Dva dugmeta u sidebar-u, iznad "Odjavi se": "Prijavi problem (Email)" — `mailto:boris.kalamanda@gmail.com` link sa predefinisanim subjektom, i "Prijavi problem (WhatsApp)" — `wa.me/38765497119` deep-link. Implementirano i testirano — oba dugmeta otvaraju ispravan kanal.
